...
from ml.predict_price import load_dataset, compute_trend_stats, empty_weather_snapshot, estimate_price
...
est = estimate_price('rice', 10, 'Bengaluru, India', ws, trend)
print('Estimate:', est)
